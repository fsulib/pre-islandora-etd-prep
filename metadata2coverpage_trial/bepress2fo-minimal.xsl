                ...
                <fo:page-sequence master-reference="coverpage">
                    <fo:flow flow-name="title" font-family="'any'" font-style="normal"
                        ...
                        <fo:block text-align="center" padding-bottom="0.25in">
                          <!--<fo:external-graphic content-height="0.75in" src="http://goldstein.cci.fsu.edu/wp-content/themes/Thesis_CI/MASTER/img/fsu-seal-80.png"/>-->
                          <!--<fo:external-graphic width="100%" content-width="scale-to-fit" src="color-lib-horiz.png"/>-->
                          <!--<fo:external-graphic content-height="2.00in" content-width="scale-to-fit" src="color-lib-vert.png"/>-->
                        </fo:block>
