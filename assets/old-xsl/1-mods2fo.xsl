...
<xsl:stylesheet
  ...
  <xsl:template match="/mods:mods">
    ...
    <xsl:variable name="subtitle" select="mods:titleInfo/mods:subTitle" as="xs:string"/>
    <xsl:variable name="title" 
      select="
      if ($subtitle ne '') then concat(mods:titleInfo/mods:nonSort,' ',mods:titleInfo/mods:title,': ',$subtitle)
      else concat(mods:titleInfo/mods:nonSort,' ',mods:titleInfo/mods:title)
      "/>
